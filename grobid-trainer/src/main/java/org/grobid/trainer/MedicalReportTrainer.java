...
import org.grobid.trainer.sax.TEIMedicalReportSaxParser;
...
/**
 * This class is for training the Medical report model
 *
 * Created: Tanti, 2020
 */
    ...
    public int addFeaturesMedical(String sourceTEIPathLabel,
        ...
        try {
            ...
            for (File tf : refFiles) {
                ...
                TEIMedicalReportSaxParser parser2 = new TEIMedicalReportSaxParser();
