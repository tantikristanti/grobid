...
/**
 * SAX parser for the TEI format for the training data for the medical report model.
 ...
 * Created: Tanti, 2020
 */
public class TEIMedicalReportSaxParser extends DefaultHandler {
    ...
    private static final Logger logger = LoggerFactory.getLogger(TEIMedicalReportSaxParser.class);
    ...
    public TEIMedicalReportSaxParser() {
