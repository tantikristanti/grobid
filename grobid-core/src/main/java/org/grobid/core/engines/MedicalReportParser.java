...
import org.grobid.core.features.FeaturesVectorMedicalReport;
...
public class MedicalReportParser extends AbstractParser {
	...
	*/
    ...
    public MedicalReportParser() {
        super(GrobidModels.MEDICAL_REPORT);
    }
    ...
    private String getFeatureVectorsAsString(Document doc, Map<String, Integer> patterns,
        ...
        // vector for features
        FeaturesVectorMedicalReport features;
        FeaturesVectorMedicalReport previousFeatures = null;
        ...
        for (Page page : doc.getPages()) {
            ...
            for (int blockIndex = 0; blockIndex < page.getBlocks().size(); blockIndex++) {
                ...
                for (int li = 0; li < lines.length; li++) {
                    ...
                    features = new FeaturesVectorMedicalReport();
